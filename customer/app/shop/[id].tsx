...
import { calculateDistance, formatDistance, getEstimatedTime, formatPrice, openGoogleMapsDirections, openPhoneCall } from '../../src/lib/utils';
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.shopInfoCard}>
          ...
          {/* Shop Quick Actions: View on Maps & Call Store */}
          <View style={styles.shopActionBtnsRow}>
            <TouchableOpacity 
              style={styles.shopMapBtn}
              onPress={() => openGoogleMapsDirections(shop.latitude, shop.longitude, shop.address, shop.name)}
            >
              <Ionicons name="navigate-circle" size={18} color="#059669" />
              <Text style={styles.shopMapBtnText}>View on Google Maps ({formattedDist})</Text>
            </TouchableOpacity>

            {shop.phone ? (
              <TouchableOpacity 
                style={styles.shopCallBtn}
                onPress={() => openPhoneCall(shop.phone || '', shop.name)}
              >
                <Ionicons name="call" size={16} color="#0284C7" />
                <Text style={styles.shopCallBtnText}>Call</Text>
              </TouchableOpacity>
            ) : null}
          </View>
        </View>
